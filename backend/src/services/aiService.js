...
const generateItinerary = async ({ destination, numberOfDays, budgetType, interests, travelStyle }) => {
...
// Estimate budget
const estimateBudget = async ({ destination, numberOfDays, budgetType, travelStyle }) => {
...
const regenerateDay = async ({ destination, dayNumber, currentActivities, preferences, numberOfDays, budgetType, interests }) => {
...
const generateWeatherAdvice = async ({ destination, numberOfDays, startDate, interests }) => {
